...
import io.github.jay890829.trailveil.data.location.LocationQualityFilter
...
internal sealed interface StoreOutcome {
    ...
    data class LocationAccepted(val kind: io.github.jay890829.trailveil.data.location.AcceptedLocationKind, val breakReason: LocationBreakReason?) : StoreOutcome
