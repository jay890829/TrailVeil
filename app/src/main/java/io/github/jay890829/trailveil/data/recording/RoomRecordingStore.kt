...
import io.github.jay890829.trailveil.data.db.RecordingReceiptOutcome
...
import io.github.jay890829.trailveil.data.location.AcceptedLocationKind
import io.github.jay890829.trailveil.data.location.LocationBreakReason
import io.github.jay890829.trailveil.data.location.LocationQualityDecision
...
internal class RoomRecordingStore(
    ...
    private fun decodeResult(
        result: io.github.jay890829.trailveil.data.db.RecordingOperationResult,
        kind: RecordingOperationKind,
    ): StoreReceipt = decode(result.receipt, kind, result.replayed)

    private fun decode(
        receipt: io.github.jay890829.trailveil.data.db.RecordingOperationReceiptEntity,
        kind: RecordingOperationKind,
        replayed: Boolean,
    ...
    private fun io.github.jay890829.trailveil.data.db.RecordingOperationReceiptEntity.toProjection(): RecordingProjection {
