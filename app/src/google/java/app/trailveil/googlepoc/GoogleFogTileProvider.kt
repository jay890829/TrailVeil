...
class GoogleFogTileOverlayController(
    /**
     * `V02-008`: internal rather than private because the stage-3 read-only spike oracle moved out
     * of this class and into `src/googlePoc`, so a release-configured Google build no longer
     * compiles ~130 lines of pixel taxonomy it can never run. One widened reference is a smaller
     * seam in shipped code than the oracle was.
     */
    internal val map: GoogleMap,
    ...
    internal companion object {
         ...
         *
         * `V02-008`: the relocated spike oracle applies the same threshold, and reads it from here
